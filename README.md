...
An e-commerce application :dress: :jeans: :shirt: consuming the dummy products api that i've created. This application was created  using plain old javascript with the help of webpack for modularity :tada:
